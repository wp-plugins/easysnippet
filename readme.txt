...
1. Go to *Plugins*
1. Select *Add New*
1. Search for "EasySnippet"
1. Select *Install*
1. Select *Install Now*
1. Once the plugin has been uploaded, select *Activate Plugin*

= Manual =

1. Download and unzip the plugin into a local folder
2. Upload the entire */easysnippet* directory to the *wp-content/plugins/* directory
3. Activate the plugin through the Plugins menu in WordPress

== Screenshots ==
1. Click on the *Rich Snippets* item in WP menu
2. Enter the number of seconds bewteen each test (be nice to Google!) and the sequence to run the test.  Click *Start*
